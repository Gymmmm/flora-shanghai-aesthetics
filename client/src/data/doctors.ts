...
export const doctors: Doctor[] = [
  ...
  },
  {
    ...
    specialties: ["Facial planning — placeholder profile"],
    primaryProcedures: ["Eyelid surgery", "Facial rejuvenation"],
    experienceYears: null,
    currentInstitution: "Institution to be confirmed",
    philosophy: "A placeholder profile for an evidence-first discussion of anatomy, expression, and realistic boundaries.",
    languages: ["Language profile to be confirmed"],
    credentials: [],
    publications: [],
    memberships: [],
    ...
    caseIds: [],
    seo: {
      title: "Dr. Si Yang | Flora Shanghai Aesthetics",
      description: "A verification-ready placeholder profile for Dr. Si Yang. Confirm credentials and institution before publication.",
    },
  },
  {
