...
export type Doctor = {
  ...
  name: string;
  chineseName: string;
  /** Green-scrub clinical portrait JPG for cards/profile. */
  photo: string;
  /** Optional object-position hint; green-scrub portraits use center 20%. */
...
export const doctors: Doctor[] = [
  {
    ...
    name: "Dr. Zhang Yalun",
    chineseName: "张亚伦",
    photo: "/images/doctors/doctor_zhang_yalun__green-scrub.jpg",
  ...
  },
  {
    ...
    name: "Dr. Si Yang",
    chineseName: "司杨",
    photo: "/images/doctors/doctor_si_yang__green-scrub.jpg",
    photoObjectPosition: "center 20%",
  ...
  },
  {
    ...
    name: "Dr. Wu Baoen",
    chineseName: "吴宝恩",
    photo: "/images/doctors/doctor_wu_baoci__green-scrub.jpg",
    photoObjectPosition: "center 20%",
  ...
  },
  {
    ...
    name: "Dr. Dong Lei",
    chineseName: "董磊",
    photo: "/images/doctors/doctor_dong_lei__green-scrub.jpg",
    photoObjectPosition: "center 20%",
  ...
  },
  {
    ...
    chineseName: "张书铭",
    photo: "/images/doctors/doctor_zhang_shuming__green-scrub.jpg",
    photoObjectPosition: "center 20%",
  ...
  },
  {
    ...
    name: "Dr. Zhao Weihui",
    chineseName: "赵伟辉",
    photo: "/images/doctors/doctor_zhao_weihui__green-scrub.jpg",
    photoObjectPosition: "center 20%",
