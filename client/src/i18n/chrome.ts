...
export const chromeCopy: Record<ChromeLocale, ChromeCopy> = {
  en: {
    ...
    surgeonsLead: "Clean clinical portraits for international patients researching Shanghai medical aesthetics. Profiles stay verification-honest.",
  ...
  zh: {
    ...
    surgeonsLead: "面向国际患者的清晰人像与英文简介；资质状态如实标注，不作夸大。",
